...
const GSAPscrollTrigger = () => {
  ...
  return (
    <section ref={container} className="relative min-h-screen w-full flex items-center justify-center py-20 px-4 overflow-hidden z-3 bg-gray-100 opacity-80">
      ...
      <div className="flex flex-col items-center text-center space-y-2">
        ...
        <div className="flex items-center justify-center flex-wrap gap-4 sm:gap-8">
          <h2 className="text-5xl sm:text-7xl md:text-8xl font-extrabold text-gray-900 tracking-tighter t1 animate-text-1 overflow-hidden">
            WE CREATE
          </h2>
          <DashedBorderImage />
        </div>
        ...
        <div>
          <h2
            className="text-5xl sm:text-7xl md:text-8xl font-extrabold tracking-tighter text-transparent t1"
        ...
        <div className="flex items-center justify-center flex-wrap-reverse gap-4 sm:gap-8">
          <h2 className="text-5xl sm:text-7xl md:text-8xl font-extrabold text-gray-900 tracking-tighter t1 animate-text-3 overflow-hidden">
            OF ENTERTAINMENT
          </h2>
          <ArchBorderImage />
        </div>
        ...
        {/* Line 4 */}
        <div className="flex items-center justify-center flex-wrap gap-4 sm:gap-8">
          <h2 className="text-5xl sm:text-7xl md:text-8xl font-extrabold text-gray-900 tracking-tighter t1">WITH</h2>
          <BracketBorderImage />
